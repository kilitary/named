      ...
      if (prefixedFolder.addCommand && prefixedFolder.folder) {
        plugin.addCommand({
          ...
          callback: async () => {
            ...
            this.openNote(prefixedFolder.folder, fullPrefix + promptValue, 0 /* sameTab */);
          }
        });
        plugin.addCommand({
          ...
          callback: async () => {
            const promptValue = await this.promptNewNote(prefixedFolder.folder);
            this.openNote(prefixedFolder.folder, fullPrefix + promptValue, "tab" /* newTab */);
          }
        });
        plugin.addCommand({
          ...
          callback: async () => {
            const promptValue = await this.promptNewNote(prefixedFolder.folder);
            this.openNote(prefixedFolder.folder, fullPrefix + promptValue, "tab" /* newTab */, false);
          }
        });
        plugin.addCommand({
          ...
          callback: async () => {
            const promptValue = await this.promptNewNote(prefixedFolder.folder);
            this.openNote(prefixedFolder.folder, fullPrefix + promptValue, "split" /* newPane */);
          }
        });
        plugin.addCommand({
          ...
          callback: async () => {
            const promptValue = await this.promptNewNote(prefixedFolder.folder);
            this.openNote(prefixedFolder.folder, fullPrefix + promptValue, "window" /* newWindow */);
          }
        });
      }
    });
...
var RapidNotesSettingsTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(this.containerEl).setName("Show prefix list in note creation modal.").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showModalSuggestions).onChange((showModalSuggestions) => {
    ...
    new import_obsidian5.Setting(this.containerEl).setName("Optional separator between the prefix and the filename (space character by default).").addText((cb) => {
      cb.setValue(this.plugin.settings.realPrefixSeparator).onChange((realPrefixSeparator) => {
        this.plugin.settings.realPrefixSeparator = realPrefixSeparator;
        this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(this.containerEl).setName("Capitalize note name and new folders.").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.capitalizeFilename).onChange((capitalizeFilename) => {
        this.plugin.settings.capitalizeFilename = capitalizeFilename;
        this.plugin.saveSettings();
      });
    });
    new import_obsidian5.Setting(this.containerEl).setClass("rapid-notes-add-prefix-entry").setName("Add new prefixes or create command shortcuts for saving directly into folders.").setDesc(createFragment((el) => {
      el.createEl("br");
    ...
    this.plugin.settings.prefixedFolders.forEach((prefixedFolder, index) => {
      const s = new import_obsidian5.Setting(this.containerEl).setClass("rapid-notes-settings-entry").setHeading().addText((cb) => {
        ...
        cb.setPlaceholder("Real prefix").setValue(prefixedFolder.filenamePrefix).onChange((newNotePrefix) => {
