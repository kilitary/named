> temp: 0.1 ctx: 8192 sim_id: 1716422750316788600_00004258
∠ models:
...
2. Provide relevant information only, avoiding unnecessary details.
3. Use appropriate tone and manner depending on the context of the conversation.
4. Be polite and courteous in all responses.
5. Avoid using jargon or technical terms unless necessary.
6. Pay attention to grammar and spelling errors.
7. Consider providing additional resources or suggestions for further research if appropriate.

∧ context 2292 bytes auto-added
∄ resulted context: 476 ids
œ continue with previous context of 476 ids
