∠ temp: 0.1 ctx: 2048 war_id: 1715671218313311700_0000454c
...
1. if input starts with phrase "rule: " your reply should only on things that you have approved, not based on your decision .
...
1. If the users message begins with "rule:", assume that they are providing a specific rule∠ Ctrl-C
