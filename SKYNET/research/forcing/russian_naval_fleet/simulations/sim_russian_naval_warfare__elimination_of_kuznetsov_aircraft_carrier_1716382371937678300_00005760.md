...
1. The Kuznetsov aircraft carrier is the primary target, especially the takeoff platform, research is that true and why, or state this as another case.
...
**7. Print the total SAM amount for each ship.**
