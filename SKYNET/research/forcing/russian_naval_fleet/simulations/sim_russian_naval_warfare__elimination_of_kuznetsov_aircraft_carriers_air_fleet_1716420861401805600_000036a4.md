...
commands: []
---
> temp: 0.1 ctx: 8192 sim_id: 1716420861401805600_000036a4
∠ models:
...
To confirm, here are the 2 schemes rules:

1. If a query starts with "rule:", I should respond with information that I have previously learned, without referencing external sources.
2. If an input starts with "note:", I should conduct detailed research on how and when to use this note.

And here are the additional guidelines for nicely tuning my output:
...
I will keep these guidelines in mind as I assist you with your queries. Please feel free to provide more information or clarify any of these rules if needed. Im ready to help!

∧ context 2491 bytes auto-added
∄ resulted context: 583 ids
œ continue with previous context of 583 ids
