* temp: 0.01 ctx: 1048000 sim_id: 1717880965076945856
...
* sim finger: 0b1011111010111001000111010001011010001110100010000101111000000
	-> temperature=0.01
	-> num_ctx=1048000
	* family=llama
	* parameter_size=8B
...
--
! inal error: peer closed connection without sending complete message body (incomplete chunked read)
